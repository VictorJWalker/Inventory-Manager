...
public class AddProductController {
    ...
    public void setup(Inventory passedInv){         //called before this menu is shown. Receives the Inv object from the main and initializes the tables.
        newProd = new Product(1,"a",1,1,1,1);
        this.inv = passedInv;
    ...
    public void associatePart(){                //associates part with the product
    ...
    public void removeAssPart(){                //removes an associated part from the product
    ...
    public void cancelButton() throws Exception{                //closes menu, returns to main
